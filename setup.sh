...
- [ ] Add movie library → folder: \`/media/movies\`$([ "$STORAGE_DIR" != "$MEDIA_DIR" ] && echo " or \`/storage/movies\`" || echo "")
- [ ] Add TV library → folder: \`/media/tv\`$([ "$STORAGE_DIR" != "$MEDIA_DIR" ] && echo " or \`/storage/tv\`" || echo "")
